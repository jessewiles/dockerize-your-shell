...
# curl -sL https://raw.githubusercontent.com/jessewiles/dockerize-your-shell/windows/setup.sh | bash -
...
GIT_URL=https://raw.githubusercontent.com/jessewiles/dockerize-your-shell/windows
